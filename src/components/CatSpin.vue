<script>
/**
 * inspired from [domaso's dribble](https://dribbble.com/domaso) [loading cat](https://dribbble.com/shots/3197970-Loading-cat)
 */
</script>
<template lang="pug">
.box
